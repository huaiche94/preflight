...
- progress artifact 中記錄 commit SHA 的欄位存在一個天生的雞生蛋、蛋生雞問題：commit 的 SHA 是以內容
  ...
  與 qa-08 在本 phase 中都遵循了同樣的模式，而沒有另外發明其他慣例。
