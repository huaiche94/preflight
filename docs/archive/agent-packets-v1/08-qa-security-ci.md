...
Do not alter feature production code in the initial pass. File defects against the owner; only A00 authorizes cross-owner fixes.
...
8. Support-bundle/doctor privacy baseline if A07 exposes it.
...
Each finding includes exact file, reproduction, expected invariant, and owning agent.
