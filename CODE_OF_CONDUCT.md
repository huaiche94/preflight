...
be reported to the community leaders responsible for enforcement via a
private **GitHub Security Advisory** on this repository (Security tab →
"Report a vulnerability" — the same private-reporting channel described
in [`SECURITY.md`](SECURITY.md); use it for conduct reports too when no
separate conduct-reporting address is available). All complaints will
